...
\begin{lemma}	\label{lemma:rebalancecost}
	The cost of a single repartition is at most $2\cdot\OPT$.
	The corollary is that \PPL is $(2\cdot (k-1)\cdot\ell)$-competitive.
\end{lemma}
...
\begin{theorem}
	The proposed algorithm for $k=3$ is $O(\ell)$-competitive.
	\label{thm:k=3}
\end{theorem}
