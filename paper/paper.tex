...
\begin{proof}
  ...
  Now we lower bound the cost of $\OPT$ by $\OPT(\sigma_I) +\OPT(\sigma_E)+\OPT(M)$, with $\sigma_I$ and $\sigma_E$ defined with respect to components of \TAlg, and $\OPT(M)$ denoting the cost of migrations performed by $\OPT$.
