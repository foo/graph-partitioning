...
\maciek{TODO: figure of three states of OPT. Maybe it would fit next to the other lower bound figure?}

\begin{theorem}
  No deterministic algorithm for BRP with two clusters can achieve a competitive ratio smaller than $2k-1$.

  \maciek{better formulation below}
  Fix any $k$. If there exists a $\gamma$-competitive \ldots (SIDMA)
\end{theorem}
