...
\begin{theorem}
  ...
  Fix any $k$. If there exists a $\gamma$-competitive deterministic algorithm $B$ for Dynamic Bisection Problem with cluster size $k$, then there exists a $\gamma$-competitive deterministic algorithm $P$ for the paging problem with cache size $2k-1$ and where the number of different pages is $2k$. 
\end{theorem}
