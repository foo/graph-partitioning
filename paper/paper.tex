...
\begin{proof}
  If no partition of \TAlg's components exists, then it simply ends the phase and performs no re-partition, thus the cost is $0$.
  ...
  %Finally, a cluster of type $C_3$  contains one component of size $3$.
    ...
    Consider a request $(u, v)$ that triggered the r-epartitiong and let $U, V$ be clusters of these nodes.
