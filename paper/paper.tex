...
\begin{theorem}
  A single repartition of DET2 migrates nodes among at most $p(k)^2+k$ clusters, where $p(k)$ is the number of integer partitions $k$.
...
\begin{proof}
  ...
  Consider a repartition from a perspective of a single cluster.
