...
\maciek{TODO: better introduction of the concept of adversary's components in the lower bound. Perhaps other name than adversary components to avoid confusion.}

\maciek{Rename components in this section to adversary's components. Until the better name is figured out.}
...
\maciek{Already mention that the LB is for that scenario, too?}
...
\begin{theorem}	\label{thm:upperbound}
    ...
    \maciek{Consider not hiding the $2(k-1)\ell$ in the theorem. This is a better bound.}
\end{theorem}
\begin{proof}
