...
\begin{proof}
  ...
  %Finally, a cluster of type $C_3$  contains one component of size $3$.
    ...
    Note that in such case, a $C_1$-type cluster $W$ exists, as otherwise no component-respecting partitioning exists. In this case \TAlg exchanges the nodes $u$ and $v$ with any two nodes of $W$, for the total cost $2\alpha$.
