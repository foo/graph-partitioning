...
\begin{proof}
	...
	Note that it is impossible that either $U$ or $V$ is of type $C_3$, as otherwise, a component of size $3$ participates in a merge.
	After the merge, we would have a component of size at least $4$, and in this case, no component respecting partitioning exists, a contradiction.
