...
\maciek{Suggestion: instead of "this means", I saw exclusively the use of "therefore", "hence" and "thus", and maybe "this implies" in papers}
...
Furthermore, we propose an efficient distributed implementation of the algorithm for $k=3$ from Section~\ref{sec:k3}.
