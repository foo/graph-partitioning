...
\begin{proof}
	...
	Otherwise, if no alone nodes exist on $I(z)$, then its largest ground set is at most $k-1$, because $z$ is on $S$.
	Hence, $\{x_0, y_0\}$ is present on $I(z)$, and we must evict it to make space for $z$.
