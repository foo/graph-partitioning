...
\maciek{OPT's cost formula: make it one line by removing the expression with minimums. Move minimums to the paragraph text, by immediately expanding minimums (two steps in paragraph, instead of in the formula)}
