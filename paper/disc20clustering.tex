...
\section{Bounding the cost of a single reconfiguration}
...
\begin{proof}
  Each node has degree at most $k$. Combine with Theorem \ref{th:cascade-paths}.
