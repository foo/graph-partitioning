...
This way, the optimal algorithm moves to such a configuration, and serves all requests for free.\maciek{i can do better: such a?}
(This implies that the algorithm must eventually collocate nodes of a ground set to be competitive.)
