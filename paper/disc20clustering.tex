...
Missing:
\maciek{Reason that the cost sharing between cases C1 and C3 is possible. Unclear to me, why every time C3 happens there must be a corresponding C1.}
...
\maciek{"Thus, OPT pays ... which gives the competitive ratio" It is too early to give the competitive ratio if in the next paragraph we consider yet another case. }

Tiny:
\maciek{$\sigma_t$ undefined (I know what it is, though).}
\maciek{Define $C^t$ to use once}
