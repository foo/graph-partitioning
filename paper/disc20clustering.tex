...
\maciek{Title discussion: "Online Graph Partitioning: Understanding the role of clusters". Reason: all our results most notably pertain to the number of clusters.}
