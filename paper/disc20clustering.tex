...
%	denoted by $x_1$.
	...
	We proceed by joining the current pivot node to a~larger ground set in a similar way,
...
%	(including $x^*$ and possibly $y^*$).	
	Each time we join the pivot node to the largest ground set of same origin.
