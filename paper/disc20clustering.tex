...
\begin{proof}
	...
	\TAlg performs at most $2 \ell$ component merge operations ---
	exceeding this number would mean that a~component of size $4$ exists, and the phase should have ended already.
	We bound the cost of a each repartition by Lemma~\ref{lem:1req}, to obtain $\TAlg(M) \leq 8\alpha\cdot\ell$.
