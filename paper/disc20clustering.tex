...
\end{theorem}
\begin{proof}
	\maciek{Maybe: "On each inter-cluster request, the algorithm enumerates all component respecting $\ell$-way partitions in the order of increasing distance to $P_I$" Then we don't need to say i.e.}
