...
\maciek{There should be a description of the algoritm. What steps it takes. Instead, we have PPL's properties here, and the algorithm description is not present at all.}
