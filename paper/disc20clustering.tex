...
In the analysis of the algorithm from Section~\ref{sec:k2}, we propose a novel charging scheme for intersecting edges.

Furthermore, we state the implications of the tight result for the learning model.
