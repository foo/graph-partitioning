...
\begin{proof}
 ...
 If it never joins a component, it is not competitive.
  ...
  If some nodes of $C$ might never appear in the sequence $\langle x^{(i)}\rangle$ %(e.g. DET might terminate prematurely or might reside in a configuration with components split)
