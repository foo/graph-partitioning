...
The OPT places these three components in clusters $A, B and D$, paying $2$ for migrating $a_3$ and $b_3$. The OPT chooses the cluster $D$ so that it does not contain neither $x$, $y$ nor $z$. The configuration of OPT's clusters is then: $A$ contains $a_1, a_2,d_1$, $B$ contains $b_1, b_2,d_2$ and $D$ contains $a_3, b_3, d_3$.
