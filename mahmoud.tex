...
As a result,
ON never ends up in a partition that is father away from $P_I$ than $\Delta$.
...
\begin{IEEEproof}
	...
	There are at most $(k-1).\ell $ calls to re-partition() and by Lemma \ref{lemma:rebalancecost} each costs at most $2.OPT$.
